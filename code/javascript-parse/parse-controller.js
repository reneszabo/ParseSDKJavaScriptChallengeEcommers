...
function renderProduct(product) {
  ...
  if ($productContainer.length === 0) {
    ...
    var $myPanel = $('<div class="panel panel-default"><div class="panel-heading title">Demo Name</div><div class="panel-body"><div style="height: 220px; overflow: hidden;"><img src="" class="img-responsive" /></div><div class="description">Demo Description</div><div class="text-right"><strong>$<span class="price"></span></strong></div></div><div class="panel-footer"><div class="text-right"><ul class="list-inline" style="margin-bottom:0;"><li><span class="stock-number small">8 in stock demo</span></li><li style="padding-right:0;"><button class="add-to-cart btn btn-info"><i class="fa fa-shopping-cart"></i></button></li></ul></div> </div></div>');
